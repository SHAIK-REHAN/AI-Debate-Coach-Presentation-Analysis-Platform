...
import EducatorKnowledgeBase from "./pages/EducatorKnowledgeBase";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/educator/knowledge-base" element={<ProtectedRoute roles={["Educator"]}><EducatorKnowledgeBase /></ProtectedRoute>} />
