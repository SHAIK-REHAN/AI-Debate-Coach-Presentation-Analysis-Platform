    ...
    <Layout>
      ...
      <div className="bg-[#1a1a2b] border border-white/5 rounded-2xl p-6 max-w-4xl">
        ...
        <button
          ...
          className="bg-purple-600 hover:bg-purple-700 disabled:opacity-50 transition text-white font-semibold px-6 py-3 rounded-lg flex items-center gap-2">
          {loading ? "Generating..." : retryCountdown > 0 ? `Please wait (${retryCountdown}s)` : "Generate Counterarguments"}
        </button>
