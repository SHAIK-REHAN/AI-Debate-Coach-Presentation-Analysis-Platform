...
_opponent_llm = get_chat_llm(model_name=settings.OPPONENT_MODEL, temperature=0.7)
...
def _get_compiled_graph(debate_format: str):
    ...
    canonical = format_config.format_name
    if canonical in _compiled_graphs:
        return _compiled_graphs[canonical]
    ...
    _compiled_graphs[canonical] = compiled
    return compiled
